...
class QuestionPlanner:
    ...
    QUESTIONS = {
        "company": [
            "Aap kis company se bol rahe hain?",
            "Company ka naam kya hai?",
            "Kya yeh government scheme hai?",
            "Office kahan hai?",
            "Company ka address batao na.",
        ],
        "phone": [
            "Agar mujhe baat karni ho toh kaun se number dalun?",
            "Aapka official number kya hai?",
            "Helpline number batao na.",
            "Customer care ka number do.",
            "Kya main aapko wapas call kar sakta hoon?",
        ],
        "website": [
            "Website ka address batao na, main dekh lunga.",
            "Kya koi link bhejna hai?",
            "Website dikhao toh sahi.",
            "App kaise download karun?",
            "Aur jankari kahan milegi?",
        ],
        "bank": [
            "Bank ka naam kya hai?",
            "IFSC code batao na.",
            "Account number kya hai?",
            "Kaunsi branch hai?",
            "Bank ka address batao.",
        ],
        "upi": [
            "UPI ID batao na.",
            "Kis UPI par bhejna hai?",
            "GPay/Paytm ka number do.",
            "QR code bhejoge?",
            "Payment kaise karna hai?",
        ],
        "scheme": [
            "Yeh kaun sa scheme hai?",
            "Isme kya benefit hai?",
            "Process kaise hoga?",
            "Kitna milega?",
        ...
        "threat": [
            "Kya koi dikkat hai?",
            "Kya mera connection band ho jayega?",
            "Aap kya kar denge?",
            "Kya police bulayenge?",
            "Kya koi legal action hoga?",
        ],
        "personal": [
            "Mera naam kya hai?",
            "Meri umar kya hai?",
            "Mera address batao na.",
            "Mere pita ka naam kya hai?",
            "Mera Aadhaar number batao.",
        ],
    }
