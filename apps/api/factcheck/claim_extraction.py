...
_CATEGORY_DESCRIPTIONS: Dict[str, str] = {
    ...
    ScamCategory.SEXTORTION: (
        "Caller demands money after a video-call recording threat or blackmail."
    ),
    ScamCategory.MATRIMONIAL_FRAUD: (
        "Fake marriage-site profile requesting money for emergencies, customs clearance, etc."
    ),
    ScamCategory.GOVT_SCHEME_IMPERSONATION: (
        "Fake PM-Kisan, Ayushman Bharat, or subsidy calls asking for OTP/bank details to release a payment."
    ),
